...
// })cmd
    ...
    <div className="container" style={{ borderTopLeftRadius: "50px" }}>
      ...
      {/* {valid ? ( */}
        ...
        {/* {valid ?( */}
          ...
          {/* {valid ? ( */}
          <div className="row ">
            <div className="col-md-6 offset-md-3 bg-warning border rounder p-4 mt-4 shadow">
       ...
       {/* )
        : (""
        // <p className="text-white text-center">no records matches</p>
   )
   }   */}
     </div>
    </div>
  ...
  function validateFormUpdate() {
    ...
    //  else if (
    //   // !/^[a-zA-Z0-9._%+-]+[0-9]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,}$/i.test(
    //     !/^[a-zA-Z]+[0-9]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,}$/i.test(
    //     customers.eMail
    //   )
    // ) {
    //   errors.eMail = "Invalid email address";
//     // }
// else if(!/^[a-zA-Z]+[0-9]+@gmail\.com$/i.test(customers.eMail)
//   ){
